...
* JudithNeve_report - the report
* JudithNeve_code - the R code necessary for the report
* winequality-red.csv - the dataset used to acquire prior information
* winequality-white.csv - the dataset used for the presented analyses
